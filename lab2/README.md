...
(Тут тобі потрібно вставити свої скріншоти з pgAdmin:)

Скріншот дерева таблиць (Browser).

Скріншот результату запиту SELECT * FROM Movie;.

Скріншот результату запиту SELECT * FROM Rental;.
