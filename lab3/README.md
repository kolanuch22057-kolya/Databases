...
Примітка: Завдяки налаштуванню ON DELETE CASCADE, усі пов'язані записи в таблиці Movie_Actor були видалені автоматично, що підтверджує цілісність бази.

6. Докази виконання (Скріншоти)
(Вставте сюди скріншоти вікна pgAdmin):

Скріншот 1: Виконання SELECT запитів (вкладка Data Output).

Скріншот 2: Стан таблиці Client після оновлення номера телефону.

Скріншот 3: Результат видалення запису (повідомлення "Delete 1").
